      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-theme-black mb-6 sm:mb-8">Send us a Message</h2>
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-theme-gray-700 mb-2">
                      Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-theme-gray-300 rounded-lg focus:ring-2 focus:ring-theme-black focus:border-transparent text-sm sm:text-base"
                      placeholder="Your full name"
                    />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-theme-gray-700 mb-2">
                      Email Address *
                    </label>
                    <input
                      type="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    <label htmlFor="phone" className="block text-sm font-medium text-theme-gray-700 mb-2">
                      Phone Number
                    </label>
                    <input
                      type="tel"
                  ...
                  <div>
                    <label htmlFor="company" className="block text-sm font-medium text-theme-gray-700 mb-2">
                      Company
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  <label htmlFor="service" className="block text-sm font-medium text-theme-gray-700 mb-2">
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-theme-gray-700 mb-2">
                    Message *
                  </label>
                  <textarea
                    id="message"
                ...
                <button
                  type="submit"
                  className="btn-primary inline-flex items-center text-sm sm:text-base px-6 sm:px-8 py-2 sm:py-3"
                >
                  Send Message
            ...
            {/* Contact Information */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-theme-black mb-6 sm:mb-8">Contact Information</h2>
              <div className="space-y-6 sm:space-y-8">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-theme-black mb-1 sm:mb-2">{info.title}</h3>
                      <p className="text-sm sm:text-base text-theme-gray-600 mb-1">{info.details}</p>
                      <p className="text-xs sm:text-sm text-theme-gray-500">{info.description}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-8 sm:mt-12">
                <h3 className="text-lg sm:text-xl font-semibold text-theme-black mb-3 sm:mb-4">Our Office</h3>
                <div className="bg-theme-gray-200 rounded-lg aspect-video flex items-center justify-center">
                  <span className="text-theme-gray-500 text-sm sm:text-base px-4 text-center">Office Map</span>
                </div>
              </div>
            </div>
          </div>
