          ...
          <div className="lg:col-span-3">
            <div className="card p-6 h-full">
              ...
              <p className="text-theme-gray-600 text-sm leading-relaxed mb-4">
                Custom AI solutions, predictive analytics, and intelligent
                automation systems that transform your business operations.
              </p>
          ...
          <div className="lg:col-span-3">
            <div className="card p-6 h-full">
              ...
              <p className="text-theme-gray-600 text-sm leading-relaxed mb-4">
                ...
                needs. We build scalable applications using modern technologies.
              </p>
              <div className="w-full h-56 bg-theme-black rounded-xl flex items-center justify-center relative overflow-hidden">
